...
function renderIntro() {
  ...
  const letterArchive = currentIntroRole === 'ai-builder'
    ? versionArchive(
  ...
  container.innerHTML = `
    ...
    <p class="intro-archive-hint">Expand the Previous version block under AI-Native Builder to compare; cite the code tag when asking to restore.</p>
